<template>
    <modal v-bind:mediaModal="true" v-bind:show="show">
        ...
        <modal-body>
                        ...
                        <div class="col-lg-2">
                            <div class="row mb-4">
                                <div class="col-lg-12">
                                    ...
                                    <a v-if="canAccess(media) || isActiveEditing()" :href="media.downloadLink" class="btn btn-primary btn-block">{{ $t('download')
                                        }}</a>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <table class="table">
                                    ...
                                    <tr v-for="license in media.licenses">
                                        ...
                                        <td>{{ license.invoiceNumber && license.invoiceNumberBy ? license.invoiceNumber
                                            + ' by ' + license.invoiceNumberBy : '' }}
                                        </td>
            ...
            <set-license-modal-component :show.sync="showLicenseModal" :media="media" :license="currentLicense"></set-license-modal-component>

            <share-media-modal-component v-if="media" v-bind:medias="shareMediaObjects" v-bind:show="showShareModal"
                                         @close="showShareModal = false"></share-media-modal-component>
