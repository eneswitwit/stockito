                        ...
                        <div class="col-lg-3">
                            <card>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="media-people-attributes" class="form-control" v-model="form.peoplesAttribute">
                        ...
                        <div class="col-lg-2">
                            <div class="row mb-4">
                                <div class="col-lg-12">
                                    ...
                                    <button @click.prevent="saveMedia" class="btn btn-success btn-block">{{ $t('save')
                                        }}
                                    </button>
                                </div>
                            </div>
