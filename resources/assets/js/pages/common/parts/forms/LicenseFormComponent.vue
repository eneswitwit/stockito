    ...
    <form action="" @keydown="form.onKeydown($event)">
        <div class="form-group">
            <div class="form-check">
                <div v-for="(license, key) in licenseTypes" class="custom-control custom-radio">
                    <input :id="'license-'+key" v-bind:key="key" type="radio" :value="key" name="licenseType"
                           v-model="form.type" class="custom-control-input"
                           :class="{ 'is-invalid': form.errors.has('type') }"/>
                    <label :for="'license-'+key" class="custom-control-label">{{ license }}</label>
                </div>
        ...
        <div v-show="form.type == 2" class="form-group">
            ...
            <input id="form-usage" class="form-control" :class="{ 'is-invalid': form.errors.has('usage') }" type="text"
        ...
        <div v-show="form.type == 3" class="form-group">
            ...
            <input id="form-territory" class="form-control" :class="{ 'is-invalid': form.errors.has('territory') }"
