    ...
    <form @submit.prevent="update" @keydown="form.onKeydown($event)">
        ...
        <card class="mb-4" title="Contact Person">
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <input v-model="form.contact_first_name" type="text" name="contact_first_name" class="form-control"
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <input v-model="form.contact_last_name" type="text" name="contact_last_name" class="form-control"
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      brand () { return this.$store.getters['auth/brand'] },
      brandImage () {
    ...
    methods: {
      ...
      setFile (event) {
        ...
        axios.post('/api/img-to-base64', formData, {headers: {
