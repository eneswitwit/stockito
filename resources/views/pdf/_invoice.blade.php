...
<table class="pdf-root">
    ...
    <tr>
        <td class="title">
            <table>
                <tr>
                    <td class="stokito-address">Stockito GmbH | Wienerweg 10 | 11000 Wien | Austria</td>
                </tr>
                <tr>
                    <td class="title-blocks">

                        <div class="title-block left-block">
                            <div class="invoice-address"> {{ $brand->name }}</div>
                        ...
                        <div class="title-block right-block">
                            ...
                            <div class="invoice-data-row">
                                <div class="invoice-data-title">Invoice Number</div>
                                <div class="invoice-data-value">{{ $invoice->id }}</div>
                            </div>
                            <div class="invoice-data-row">
                                <div class="invoice-data-title">VAT ID</div>
                                <div class="invoice-data-value"> {{ $brand->eur_id }}</div>
                            </div>
                        </div>
                    </td>
                </tr>
